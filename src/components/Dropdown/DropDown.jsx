...
const Dropdown = ({ label }) => {
  return (
    <Menu as="div" className="relative inline-block text-left">
      <Menu.Button className="btn btn-secondary text-[11px] leading-4 box-border px-2 py-1 inline-flex justify-center uppercase rounded shadow-sm border-0 bg-secondary-light">
        <span>{label}</span>
        <img
          alt=""
      ...
      >
        <Menu.Items className="absolute right-0 z-10 mt-2 origin-top-right border-0 rounded-md min-w-[160px] shadow-custom bg-custom-secondary ring-opacity-5">
          <div className="py-1">
            <DropdownItem label="View details" />
